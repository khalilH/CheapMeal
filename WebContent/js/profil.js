$(function (){
	...
	Recette.prototype.getHtml=function(){
		var s ="<div class='col-sm-12'>"+
				...
				"<div class='media-body'>" +
					"<h3 class='media-heading'>"+this.titre+"</h3>" +
	...
	InformationProfil.prototype.getHtmlProfilCard = function(){
		var s ="<div class='row pad15'><div class='col-sm-12'>" +
			"<h3>"+this.profil.login+"</h3>" +
			"<img class='img-responsive' id='profilPicture'" +
				"src='"+this.profil.photo+"' alt='Profil Picture'>";
		if(getCookie(C_NAME_LOGIN) == this.profil.login){
			s+="<div id='connected'>" +
				"<div class='arrow-bottom'></div>" +
				"<button type='button'"+
					"class='btn btn-md btn-primary form-control'>Modifier photo</button></div>";
		}
		...
		s += "</div><div class='row '>" +
			"<div class='col-sm-12 white-text mg-top-10'>" +
				"<div class='col-sm-4 no-pad bg-blue'>" +
					"<div class='h4'>" +
						"<span class='glyphicon glyphicon-user'></span> Left</div>" +
				"</div><div class='col-sm-4 no-pad bg-pink'>" +
					"<div class='h4'>" +
						"<span class='glyphicon glyphicon-star'></span>"+getStars()+"</div>" +
				"</div><div class='col-sm-4 no-pad bg-green'>" +
					"<div class='h4'>" +
						"<span class='glyphicon glyphicon-star'></span>"+nbRecettes+"</div>" +
				"</div></div></div></div>";
		return s;
	}
	function getStars(){
